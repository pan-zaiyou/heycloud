...
const LogoMain = ({ reverse, ...others }: { reverse?: boolean }) => {
  ...
  return (
     ...
     *
     * <img src={theme.palette.mode === 'dark' ? logoDark : logo} alt="XGW" width="50" />
     *
     */
    <>
      <svg fill="#000000" width="80px" height="53px" viewBox="0 -2 118 28.12" xmlns="http://www.w3.org/2000/svg">
